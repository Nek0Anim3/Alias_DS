# Alias Discord Bot
This repo is about my college project, discord bot to play alias with friends. 
Currently i'm planning only a few features, but maybe in future i will add more and more stuff (or just abandon this project). 
